...
- Concrete supports only support the same range as wood ones. Rebar/steel/reinforced concrete supports are unaffected
- Some loot chests and vessels in the new towers are empty.
