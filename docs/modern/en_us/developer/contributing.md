...
>&emsp;│&emsp;│&emsp;│&emsp;🗎 <abbr title="Constants files are used to store variables to be declared all through out the codebase. Using the `global.` prefix for functions and constants lets you call them elsewhere.">[`constants.js`](https://github.com/TerraFirmaGreg-Team/Modpack-Modern/blob/dev/kubejs/startup_scripts/tfg/constants.js)</abbr>\
